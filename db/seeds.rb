...
The palace is illuminated with lights that make it appear to glow. As Asir is a cold region, in the winter fog looms around the castle', :places => 'Asir', :points_of_interest => 'kjhg', :time => '2020-05-10 00:00:00', :duration => '5hr', :trip_image => 'https://images.app.goo.gl/nULyh8fcMoASrTxPA' ,:city => 'Asir'
##############
##############
trip = Trip.create! :user_id => 3, :name => 'Alsouda', :description => 'is a tourist village in the Abha region of Saudi Arabia, located about 28 kilometres (17 mi) from the city of Abha. It is 3,015 metres (9,892 ft) above sea level,[citation needed] and its mountains are covered with dense juniper trees', :places => 'Jeddah', :points_of_interest => 'jhg', :time => '2019-12-23 00:00:00', :duration => '5hr', :trip_image => 'https://images.app.goo.gl/x8UkzszER7QrPP148 ',:city => 'Jeddah'
##############
##############
trip = Trip.create! :user_id => 3, :name => 'Alsouda', :description => 'is a tourist village in the Abha region of Saudi Arabia, located about 28 kilometres (17 mi) from the city of Abha. It is 3,015 metres (9,892 ft) above sea level,[citation needed] and its mountains are covered with dense juniper trees', :places => 'Asir', :points_of_interest => 'fgbhnm', :time => '2020-04-10 00:00:00', :duration => '5hr', :trip_image => 'https://images.app.goo.gl/x8UkzszER7QrPP148 ' , :city => 'Asir'
##############
##############
trip = Trip.create! :user_id => 3, :name => 'Aldriah', :description => 'AlDiryah is the first Saudi state capital established in 1745 (1158H) which has the most glorious buildings and attractions. Join us for two days where we explore the Kingdom’s second UNESCO World Heritage Site.', :places => 'Riyadh', :points_of_interest => 'ghj', :time => '2020-08-07 00:00:00', :duration => '6hr', :trip_image => 'https://images.app.goo.gl/VVjfojDxuJ6bJ7XX9' , :city => 'Riyadh'
##############
##############
trip = Trip.create! :user_id => 4, :name => 'Al-Thumamah', :description => 'AlDiryah is the first Saudi state capital established in 1745 (1158H) which has the most glorious buildings and attractions. Join us for two days where we explore the Kingdom’s second UNESCO World Heritage Site.', :places => 'Riyadh', :points_of_interest => 'kjhg', :time => '2019-12-07 00:00:00', :duration => '6hr', :trip_image => 'https://ammartours.com/wp-content/uploads/Untitled-6-Copy-Copy-2.png' , :city => 'Riyadh'
##############
##############
trip = Trip.create! :user_id => 4, :name => 'Nova Safari', :description => 'Nofa safari park used to be accessible only through corporate visits, VIP bookings and events. I’ve visited Nofa on several occasions during these events and private visits, always hoping they’d open this amazing place for the public one day.  Starting from November 2017 this dream came true and the Nofa resort has finally opened their safaris for the public!', :places => 'Riyadh', :points_of_interest => 'ggg', :time => '2020-07-13 00:00:00', :duration => '6hr', :trip_image => 'https://images.app.goo.gl/wnokhEBGMvKR2sMs5   ' , :city => 'Riyadh'
##############
##############
trip = Trip.create! :name => "AL Fara'a Park", :description => 'One of the most beautiful tourist parks in Abha
It is the largest family park in the Asir region, covering an area of ​​200,000 square meters. Its summer activities include Egyptian circus acrobatics, folklore folklore, carnival, the childrens tent, electronic games, water games, a club and a childrens cinema, competitions and various entertainment programs. The park will be located amid the forests and terraces and near Prince Sultan Al Bari Park, and will continue from morning till midnight.', :places => 'Abha', :points_of_interest => 'fff', :time => '2020-07-13 00:00:00', :duration => '6hr', :trip_image => 'https://images.app.goo.gl/wnokhEBGMvKR2sMs5',:user_id => 5 , :city => 'Abha'
##############
##############